...
<body>
	...
	<script type="text/javascript" src="{{asset('component/query/dist/jquery.min.js')}}"></script>
	<script type="text/javascript" src="{{('asset(compnent/bootstrap/dist/js/bootstrap.min.js')}}"></script>
